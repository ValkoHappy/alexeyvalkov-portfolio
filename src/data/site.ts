...
const projectCatalog: Project[] = [
  ...
  },
  {
    ...
    summary: "Сервис отслеживает освободившиеся места на экзамен RSA Ireland. Пользователь задаёт параметры поиска и сам подтверждает найденный вариант.",
    description:
      "Пользователь принимает приглашение, подключает RSA-аккаунт, задаёт параметры поиска и подтверждает найденный вариант. Сервер хранит сессии в зашифрованном виде, запускает задания мониторинга и восстанавливает их после ошибок.",
    ...
    highlights: [
      ...
      "Тестовый RSA-сервис, проверки нагрузки и защищённый просмотр событий"
    ],
...
export const projectDetails: Record<string, ProjectDetails> = {
  ...
  "driving-test-auto-booking": {
    ...
    solution: "Связал React-интерфейс с серверным шлюзом, клиентом RSA, заданиями PostgreSQL и отдельными процессами мониторинга. Добавил защищённые сессии и тестовый контур RSA.",
