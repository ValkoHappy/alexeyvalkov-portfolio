...
export default async function EnglishProjectPage({ params }: Props) {
  ...
  return <main><div className="page-shell"><Header locale="en" /><article className="case-page">
    ...
    <section className="case-story"><div className="case-story-title"><span>Project summary</span><h2>Problem, my work, result</h2></div><div className="case-story-grid"><article><Target size={23} /><span>01 / Problem</span><p>{details.challenge}</p></article><article><Layers3 size={23} /><span>02 / What I built</span><p>{details.solution}</p></article><article><Zap size={23} /><span>03 / Result</span><p>{details.outcome}</p></article></div></section>
